...
\begin{description}
	...
	\item[B-2]{The CIA team led by the CTC director Carrie Mathison has received valuable intel on ongoing terrorism activity.
		The infamous terrorist Abu Nazir has been communicating through a Mix network\footnote{\url{https://en.wikipedia.org/wiki/Mix_network}}, 
		a system that allows for anonymous communication. The security team has been analyzing the network traffic to and from the Mix, but
		...
		You are given example code in Python\footnote{\url{https://github.com/eit-lth/Advanced-Web-Security_EITN41/tree/master/2\%20Anonymity/code/}}, which uses the \texttt{pypcapfile}\footnote{\url{https://github.com/kisom/pypcapfile}} library.
		...
		\begin{itemize}
			...
			\item[-] The number of partners of Nazir.
