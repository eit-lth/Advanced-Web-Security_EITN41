	...
	\begin{description}
		\item[C-1]{Implement the coin withdrawal (the version with 2k quadruples) in the untraceable e-cash
			...
			\begin{itemize}
				...
				\item The data transfer can be simulated locally inside the program, i.e., you do not have to communicate data over a network.
				...
				\item Choose sensible functions $f$ and $h$ so that the specific properties, as per the paper, are fulfilled. Motivate your choices clearly.
				\item Be careful when choosing your $r_i$. Not all choices are suitable, why? Remember that you need to be able to un-blind the values later on.
			\end{itemize}
